...
export default class LostThingsPost extends React.Component{
 ...
 /***********Image Picker Package  */
    ...
    return (
      ...
      <View style ={styles.Container}>
              ...
              <Text style={styles.WelcomText} > Lost Things Post</Text>
